...
export default function SignupDialog({ open, onClose, onBackToLogin }) {
        ...
        <div className="Modal_body__7nSTF">
              ...
              <div className="FormGroup_form-group__u5fIf">
                ...
                <div className="FormField_field-wrapper__CGO3M">
                  <label className="FormFieldLabel_label___P3oR">
                    <span className="TextSizes_body-medium__vDuC4">First name</span>
                  </label>
                ...
                <div className="FormField_field-wrapper__CGO3M">
                  <label className="FormFieldLabel_label___P3oR">
                    <span className="TextSizes_body-medium__vDuC4">Last name</span>
                  </label>
                  <div className="Input_input-wrapper__XGKui">
                    <input 
                      name="lastName"
          ...
          <div className="MergedLoginRegisterBox_login__JhDib">
            ...
            <button 
              ...
              onClick={onBackToLogin}
            >
              <span className="Button_text__Pv_HU">Sign in here</span>
            </button>
          </div>

          <p className="TextAligns_center__rmxjf TextSizes_small__OjaQU MergedLoginRegisterBox_terms-and-policy__UJqSs">
            By signing up, you agree to Studocu’s <a href="#" className="LinkVariants_blue__Qn_6n">Terms of Use</a> and <a href="#" className="LinkVariants_blue__Qn_6n">Privacy policy</a>.
          </p>
        </div>
